                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            @auth 
                                ...
                                @else 
                                    <li><i class="ti-user"></i> <a href="{{route('userproduct.index')}}" >Mon profile</a></li>
                                @endif
                                    ...
                                    <div class="nav-inner"> 
                                        <ul class="nav main-menu menu navbar-nav">
                                            <li class="{{Request::path()=='home' ? 'active' : ''}}"><a href="{{route('home')}}">Accueil</a></li>
                                                                                       <li class="@if(Request::path()=='product-grids'||Request::path()=='product-lists')  active  @endif"><a href="{{route('product-grids')}}">Annonces</a><span class="new">New</span></li>                                              
