...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     <h4 class=" font-weight-bold">Mon profile</h4>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body mt-4 ml-2">
                      ...
                      <p class="card-text text-left"><small class="text-muted"><i class="fas fa-user"></i> {{$profile->role}}</small></p>
                    </div>
                  </div>
            </div>
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('user-profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <button type="submit" class="btn btn-success btn-sm">Actualiser</button>
                </form>
            </div>
        </div>
   </div>
...
<style>
    ...
    .image{
        background:url('{{asset('backend/img/couverture.jpg')}}');
        height:150px;
