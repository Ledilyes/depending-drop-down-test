...
class FrontendController extends Controller
{
    ...
    public function home(){
        ...
        // return $banner;
        $products=Product::where('status','active')->limit(9)->orderBy('created_at','DESC')->get();
    ...
    public function productDetail($slug){
        Product::getProductBySlug($slug)->increment('vue');
...
;
    ...
    public function getcity(Request $request){
           ...
           $city=DB::table('cities')->where('state_id',$state)->get();
            ...
            $html_option="<option value=''>----Sélect----</option>"
            ;

           foreach ($city as $list) {
               $html_option.="<option value='" .$list->id . "'>" .$list->name . "</option>";
           }
